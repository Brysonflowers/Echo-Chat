"""
Django settings for textingproject project.
...
SECRET_KEY = 'django-insecure-5@ecm2h%+6!u75f2u-69y-mt8@k7o$0a_p2u$e024a(p_&mzn2'
...
ROOT_URLCONF = 'textingproject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['echochatapp/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#WSGI_APPLICATION = 'textingproject.wsgi.application'
